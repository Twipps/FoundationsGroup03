...
public class PasswordEvaluationTestingAutomation {
	...
	private static void performTestCase(int testCase, String inputText, boolean expectedPass) {
		...
		String resultText= passwordPopUpWindow.ModelPassPopUp.evaluatePassword(inputText);
	...
	private static void displayEvaluation() {
		...
		if (passwordPopUpWindow.ModelPassPopUp.foundUpperCase)
		...
		if (passwordPopUpWindow.ModelPassPopUp.foundLowerCase)
		...
		if (passwordPopUpWindow.ModelPassPopUp.foundNumericDigit)
			System.out.println("At least one digit - Satisfied");
		else
			System.out.println("At least one digit - Not Satisfied");

		if (passwordPopUpWindow.ModelPassPopUp.foundSpecialChar)
		...
		if (passwordPopUpWindow.ModelPassPopUp.foundLongEnough)
