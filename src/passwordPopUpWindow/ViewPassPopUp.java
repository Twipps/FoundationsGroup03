...
public class ViewPassPopUp {
	...
	//This is the window size for password pop up windows
	private static double windowWidth = 500;
	private static double windowHeight = 430;
	
	//Private reference to the view for singleton application
	private static ViewPassPopUp theView;
	...
	private static Pane theRoot;				//Pane that holds all the GUI widgets
	protected static Stage theStage;			// The Stage that JavaFX has established for us
	private static User theUser;				// The current user of the application
	
	public static Scene thePassPopUpScene = null;	// The Scene each invocation populates
	...
	private ViewPassPopUp() {
		...
		button_Finish.setOnAction(new EventHandler<>() {	// Specify the event handler to be
        	public void handle(ActionEvent event) {			// called when the button is pressed
        		ControllerPassPopUp.handleButtonPress(theUser);
        	}
        });
	}
	...
	public static void view (User user) {
		...
		// Place the GUI widgets into the pane, whether they have text or not
