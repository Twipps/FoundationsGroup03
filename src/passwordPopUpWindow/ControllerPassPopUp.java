 ...
 */
	...
	static protected void handleButtonPress(User theUser) {
 		ViewPassPopUp.theStage.hide();
		String thePassword = ViewPassPopUp.text_Password.getText();
		
    	// update our password in the database
    	theDatabase.updatePassword(theUser.getUserName(), thePassword);
    	
    	//update our user object
    	theUser.setPassword(thePassword);
    	
    	guiUserUpdate.ViewUserUpdate.updateFields(theUser);
